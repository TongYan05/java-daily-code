...
public class student extends member implements Borrowable, Discountable{
    ...
    public student(String name,int age,int VIPnumber,double balance,int borrowednumber)
    {
